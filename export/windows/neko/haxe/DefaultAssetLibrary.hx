...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/mountain_1.png", AssetType.IMAGE);
		...
		type.set ("assets/sounds/PowerUpSelection.wav", AssetType.SOUND);
		...
		id = "assets/images/mountain_1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/mountain_2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.SOUND);
		id = "assets/sounds/PowerUpSelection.wav";
		path.set (id, id);
		type.set (id, AssetType.SOUND);
